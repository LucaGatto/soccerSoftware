...
public class Test {
	...
	public static void main(String[] args) {
		...
		//Lodi's test
		CalcetoManager manager = new CalcetoManager();
		

		System.out.println("Statistics of Player ");
		trn.addGoal(m3, t7, p1);
		
		manager.update();
		
		pl1.showStatistic(new PlyaerGoalScoredStrategy());
		pl1.showStatistic(new PlayerMatchesWonStrategy());
		
		System.out.println("Statistics of Team :  ");
		t1.showStatistic(new TeamMatchesWon());
		t1.showStatistic(new TeamTournamentWon());
	}
