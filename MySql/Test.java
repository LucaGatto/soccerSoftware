...
public class Test {
	...
	public static void main(String[] args) {
		...
		TourGold trn = new TourGold("TorneoTest", team , new SimpleMatchweekCreator()); //simplMatcCreator si occupa della creazione di tutte le matchweek (Strategy)
		...
		cal.printRanking(trn,new ShowRanking());
