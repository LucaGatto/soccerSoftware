...
public class Test {
	...
	public static void main(String[] args) {
		...
		PlayerCard pl3 = new PlayerCard();
		PlayerCard pl4 = new PlayerCard();
		PlayerCard pl5 = new PlayerCard();
		PlayerCard pl6 = new PlayerCard();
		PlayerCard pl7 = new PlayerCard();
		PlayerCard pl8 = new PlayerCard();
		...
		int [] premiGold = new int[3]; //premi per i primi 3 classificati
		premiGold[0] = 7000;
		premiGold[1] = 5000;
		premiGold[2] = 300;
		
		
		TourGold trn = new TourGold("TorneoTest", team, false, new SimpleMatchweekCreator()); //simplMatcCreator si occupa della creazione di tutte le matchweek (Strategy)
		
		//trn.setPrizes(premiGold);
		...
		System.out.println("Visitor Show Ranking : ");
		Calcetto cal = new Calcetto();
		
		cal.printRanking(trn);
